...
function httpgetx(dataxxx, server){
    ...
    xhr2.open('GET', 'https://www.uptoplay.net/runapk/security.php?username=' + dataxxx + '&service=' + server, true);
    xhr2.onload = function (e) {
       if (xhr2.status === 200) {
            ...
            if ( runningx.indexOf("runX") != -1 )
            {
                ...
                window.location = "https://www.uptoplay.net";
            }
        }
        else {
    ...
    setTimeout(function() {
		...
		var xhr = new XMLHttpRequest();
                xhr.open('GET', "https://www.uptoplay.net/community/user.php?username=" + dataxxx + '&service=' + server, true);
                xhr.send();
...
function runstartgame() {
        ...
        if ( getCookie("apk") )  {
                xhr1.open('GET', "https://www.uptoplay.net/playonline/startgame2.php?apk=" + getCookie("apk"), true);
        } else {
                xhr1.open('GET', "https://www.uptoplay.net/playonline/startgame2.php?apk=com.innersloth.spacemafia", true);
        }
			...
			reshowx =  1;
                        ...
                        googletag.cmd.push( function() {
                                var rewardedSlot = googletag
                                        .defineOutOfPageSlot('/147246189,22385467611/uptoplay.net_web_rewarded',googletag.enums.OutOfPageFormat.REWARDED)
				...
				//myEnterXXX();
                        ...
                        googletag.cmd.push( function() {
                                var rewardedSlot = googletag
                                        ...
                                        .addService(googletag.pubads());
                                googletag.enableServices();
                                googletag.pubads().addEventListener('rewardedSlotReady', function(evt) { viendolovideos = 1; evt.makeRewardedVisible(); });
...
function myEnterXXX() {
   ...
   setTimeout(function() {
	...
	iframe.src = "https://www.uptoplay.net/playonline/inprogress.php?mobile=" + mobile;;
	...
	var extensionxxyy = "";
       ...
       setTimeout(
            function(){
                ...
                xhrxxx1.open('GET', 'https://www.uptoplay.net/community/user.php?username=' + username, true);
                xhrxxx1.send();
        ...
        setTimeout(
            function(){
                ...
                xhrxxx2.open('GET', 'https://www.uptoplay.net/community/user.php?username=' + username, true);
                xhrxxx2.send();
                iframe = document.getElementsByClassName('responsive-iframe')[0];
                inactivityTime(iframe);
            }
        ...
        var xhr1 = new XMLHttpRequest();
        xhr1.open('GET', 'https://www.uptoplay.net/community/user.php?username=' + username, true);
        xhr1.onload = function (e) {
  		if (xhr1.readyState === 4) {
    			if (xhr1.status === 200) {
				...
				if ( getCookie("apk") )
					...
					if ( apkapk.indexOf("RunEmulato") != -1 )
					{
						...
						xhr2.open('GET', 'https://www.uptoplay.net/runapk/create-androidapk.php?mobile=' + mobile + '&service=' + response1 + '&username=' + username + '&app=&apk=' + extensionxxyy, true);
					}
					else {
                                  		xhr2.open('GET', 'https://www.uptoplay.net/runapk/create-androidapk.php?mobile=' + mobile + '&service=' + response1 + '&username=' + username + '&app=&apk=' + getCookie("apk") + extensionxxyy, true);
					}
                                }
                                else {
				  	xhr2.open('GET', 'https://www.uptoplay.net/runapk/create-androidapk.php?mobile=' + mobile + '&service=' + response1 + '&username=' + username + '&app=&apk=com.innersloth.spacemafia' + extensionxxyy, true);
				}
				xhr2.onload = function (e) {
					if (xhr2.status === 200) {

						var xhr3 = new XMLHttpRequest();
        					xhr3.open('GET', 'https://www.uptoplay.net/community/user.php?username=' + username, true);
						xhr3.send();
						...
						finalurl_x =  "https://stream.uptoplay.net/osessionx" + numserver + "/#/?username=" + guest + "&password=server01" + numguest;
